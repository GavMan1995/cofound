...
class EnhancedTable extends Component {
            ...
            <TableBody>
                    ...
                    <TableRow
                      ...
                      {keys.map((val, key) => {
                        ...
                        return val !== 'dataTableId' &&
                          <TableCell key={key} padding='dense' numeric={typeof obj[val] === 'number'}>
                            {obj[val]}
                          </TableCell>
                      })}
                    </TableRow>
              ...
              {totals &&
                <TableRow>
                  ...
                  {totals.map(total =>
                    <TableCell className={classes.grayBG} numeric={typeof total === 'number'}>
                      {total}
                    </TableCell>
                  )}
                </TableRow>
  ...
  onLinkPage = href => {
    window.location.href = this.props.initialRoute
